...
ONCHAIN_ENTITIES = [
    ...
    {"id": "proto_uniswap", "name": "Uniswap", "type": "DEX_Protocol", "aliases": ["Uniswap Labs", "UNI", "Hayden Adams"]},
    {"id": "proto_ethereum", "name": "Ethereum", "type": "L1_Blockchain", "aliases": ["ETH", "Mainnet", "Vitalik Buterin"]},
    {"id": "proto_aave", "name": "Aave", "type": "Lending_Protocol", "aliases": ["ETHLend", "Aave Labs", "Stani Kulechov"]},
    {"id": "proto_curve", "name": "Curve Finance", "type": "Stableswap_DEX", "aliases": ["Curve", "CRV", "Michael Egorov"]},
    {"id": "proto_eigenlayer", "name": "EigenLayer", "type": "Restaking_Protocol", "aliases": ["Eigen", "Sreeram Kannan"]},
    {"id": "proto_makerdao", "name": "MakerDAO", "type": "CDP_Protocol", "aliases": ["Sky", "DAI", "Rune Christensen"]},
    {"id": "proto_euler", "name": "Euler Finance", "type": "Lending_Protocol", "aliases": ["Euler", "EUL", "Michael Bentley"]},

    # ─── Smart Contracts & Implementations ───
    {"id": "contract_univ1_factory", "name": "UniswapV1Factory", "type": "SmartContract", "address": "0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95"},
    {"id": "contract_univ2_factory", "name": "UniswapV2Factory", "type": "SmartContract", "address": "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"},
    {"id": "contract_univ3_factory", "name": "UniswapV3Factory", "type": "SmartContract", "address": "0x1F98431c8aD98523631AE4a59f267346ea31F984"},
    {"id": "contract_univ4_poolmanager", "name": "UniswapV4PoolManager", "type": "SmartContract", "address": "0x000000000004444c5dc75cB358380D2e3dE08A90"},
    {"id": "contract_aave_v3_pool", "name": "AaveV3PoolAddressesProvider", "type": "SmartContract", "address": "0x2f39d218133AFaB8F2B819B1066c7E434Ad94E9e"},
    {"id": "contract_euler_etoken", "name": "EulerEToken", "type": "SmartContract", "address": "0xbbbbbbbb29d6606822736796ec56bb01ec04e5c4"},

    # ─── Core Upgrades & EIPs ───
    {"id": "eip_1559", "name": "EIP-1559", "type": "Ethereum_Standard", "title": "Fee market change for ETH 1.0 chain"},
    {"id": "eip_4844", "name": "EIP-4844", "type": "Ethereum_Standard", "title": "Shard Blob Transactions (Proto-Danksharding)"},
    {"id": "eip_4337", "name": "EIP-4337", "type": "Ethereum_Standard", "title": "Account Abstraction using Alt Mempool"}
]
...
ONCHAIN_SUPERSEDED_CHAINS = [
    ...
    ("fact_euler_exploit", "fact_euler_recovered", "exploit_resolution_and_v2_pivot", 1680566400000)
]
